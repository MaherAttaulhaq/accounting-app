            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                ...
                <Input
                  ...
                  required
                  className="bg-slate-800/50 border-slate-700 text-white placeholder:text-slate-500 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 h-11"
                />
              </motion.div>
              ...
              >
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-2.5 transition-all duration-200 shadow-lg shadow-blue-600/20"
                >
                  {loading ? (
                    <motion.div
                      animate={{ rotate: 360 }}
